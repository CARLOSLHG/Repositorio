    (function() {
        ...
        function initGame() {
            ...
            function startAmmoPacks() {
                let spawnDelay = 12000;      // Cada 12 segundos al inicio
                const maxDelay = 30000;      // Máximo 30 segundos entre packs
                const delayIncrease = 1000;  // Incremento de 1s por cada spawn
